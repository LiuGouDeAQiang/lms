...
func New(cmd *cobra.Command, args []string) {
	...
	{
		i.GET("/users/create", logic.GetCreate)
		i.POST("/users", logic.CreateUser)
		i.POST("/users/img/upload", logic.GetUserImg)
	}
	{
	...
	{
		i.POST("/books", logic.AddBooks)
		i.PUT("/books/:title", logic.UpdateBooks)
		i.DELETE("/books/:title", logic.DelBooks)
